...
})({"h6F5f":[function(require,module,exports) {
...
// <block:setup:1>
// const color1 = 'rgba(22, 24, 37, 1)';
// const color2 = 'rgba(178, 136, 124, 1)';
// const color3 = 'rgba(255, 255, 255, 1)';
// const color4 = 'rgba(0, 0, 0, 0.3)';
// Chart.defaults.font.display = none;
...
// </block:setup>
new (0, _auto.Chart)(document.getElementById("radar"), {
    type: "radar",
    data: data,
    options: {
        radius: 3,
        ...
        scales: {
            r: {
                animate: true,
                // startAngle: 60,
                // max and min of grid line range number
                ...
                // Spider-web in simple worlds
                grid: {
                    color: "#BA692C"
                },
                // Spider-web's straight lines
                angleLines: {
                    color: "#000"
                }
            }
...
},{}]},["h6F5f","la82z"], "la82z", "parcelRequire30ab")
